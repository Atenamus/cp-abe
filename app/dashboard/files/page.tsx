...
export default function FileManagementPage() {
  ...
  const handleDownload = (fileId) => {
    toast({ title: "Download Started", description: `Downloading file ${fileId}` })
  }

  const handleDelete = (fileId) => {
    toast({ title: "File Deleted", description: `File ${fileId} has been removed` })
  }
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button asChild>
          <Link href="/dashboard/files/encrypt">
