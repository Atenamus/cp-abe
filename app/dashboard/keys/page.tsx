...
export default function KeyManagementPage() {
  ...
  const handleGenerateKey = async () => {
    ...
    try {
      ...
      toast({ title: "Key generated successfully", description: "Your new key pair has been created" })
    } catch {
      toast({ title: "Failed to generate key", description: "There was an error generating your key pair", variant: "destructive" })
    } finally {
  ...
  const handleDeleteKey = async (keyId: string) => {
    ...
    try {
      ...
      toast({ title: "Key deleted", description: "The key has been deleted successfully" })
    } catch {
      toast({ title: "Failed to delete key", description: "There was an error deleting the key", variant: "destructive" })
    } finally {
      setIsDeleting(false)
      setSelectedKey(null)
    }
  ...
  const handleDownloadKey = (keyId: string, keyType: string) => {
    toast({ title: "Key downloaded", description: `Your ${keyType} key has been downloaded` })
  }
